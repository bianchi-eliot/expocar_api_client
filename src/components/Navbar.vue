<template>
    <nav class="navbar" :class="{ extend: extend }">
        <ul class="navbar-list">
            <img v-if="true" class="account-svg" src="../assets/svg/user_account.svg" alt="account-image">
            ...
            <!--<li class="navbar-list-element">
                <router-link :to="{ name: 'log-out' }"> 
                    <svg width="64" height="64" viewBox="0 0 16.933333 16.933333">
                        <path d="M 14.684375,2.2489588 H 10.583333 V 1.0583338 H 15.875 V 15.875 h -5.291667 v -1.190625 h 4.101042 z"/>
                        <path d="M 10.054167,7.8713547 7.4083343,5.0270838 8.3343753,4.2333338 12.303125,8.4666672 8.3343753,12.7 7.4083343,11.90625 10.054167,9.0619797 H 1.0583338 v -1.190625 z"/>
                    </svg> 
        ...
        <ul v-if="true" class="navbar-list">
            <li class="navbar-list-element">
